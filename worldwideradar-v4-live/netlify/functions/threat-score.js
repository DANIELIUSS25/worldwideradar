...
const ALLOWED_ORIGIN = "https://worldwideradar.com";
...
function safeHeaders(event) {
  ...
  const isProd  = origin.includes("worldwideradar.com");
  if (!isLocal && !isProd && origin !== "") return null;
  return {
    "Access-Control-Allow-Origin": isProd ? ALLOWED_ORIGIN : "*",
